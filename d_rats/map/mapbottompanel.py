...
class MapControls(Gtk.Box):
    ...
    def __init__(self, map_window):
        ...
        self.set_spacing(2)
        self.zoom_control = Map.ZoomControls(map_window.map_widget)
        self.pack_start(self.zoom_control, False, False, False)
        self.make_track = MapMakeTrack(map_window)
        self.pack_start(self.make_track, False, False, False)
        self.show()
...
class MapBottomPanel(Gtk.Box):
    ...
    def __init__(self, map_window):
        ...
        self.set_spacing(2)
        self.marker_list = Map.MarkerList(map_window)
        self.pack_start(self.marker_list, True, True, True)
        self.controls = MapControls(map_window)
        self.pack_start(self.controls, False, False, False)
        self.show()
